...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='/home/ytang363/7100_voiceConversion/VCTK-Corpus-0.92/spmel-16k')
    parser.add_argument('--batch_size', type=int, default=2, help='mini-batch size') # 2
    parser.add_argument('--num_iters', type=int, default=1, help='number of total iterations') # 1500000
